...
/**
 * The ExampleItem class contains the items to be added to the RecyclerView list. This is essentially a "converter" class from PoInterest to a usable item within the RecyclerView
 *
...
class ExampleItem {
    ...
    /**
     * Constructor of objects of type ExampleItem
